module Redis : sig
    ...
    module Resp : sig
      ...
      (** A message was decoded, but the end of the stringtring was not reached. Contains the decoded message and the offset at which the "garbage" starts. *)
    ...
    module Conv : sig
        ...
        val array : t -> t array
        val list : t -> t list
        val hashtbl : t -> (string, t) Hashtbl.t
        val int : t -> int
        val int64 : t -> int64
        val float : t -> float
    end
